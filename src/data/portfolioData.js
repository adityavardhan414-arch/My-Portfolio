  ...
  projects: [
    {
      ...
      description: "Built a habit-tracking web app enabling users to create,  and delete habits, log daily completions, and monitor consistency over time and implemented streak-tracking logic to give users real-time feedback on habit consistency, encouraging sustained engagement and deployed on Render",
    ...
    },
    {
      ...
      description: "Designed and developed a personal portfolio website using React to showcase projects, skills, and background in a clean, responsive interface and built and deployed a full front-end application from scratch, handling component architecture, styling, and production deployment via Render",
      technologies: ["JavaScript", "React"],
      githubLink: "https://github.com/adityavardhan414-arch/My-Portfolio",
      liveLink: "https://my-portfolio-ddey.onrender.com",
    },
  ],
